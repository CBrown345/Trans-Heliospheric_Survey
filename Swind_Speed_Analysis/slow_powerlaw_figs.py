...
def plot_msc( key, scaled=True ) :
	...
	if ( scaled ) :
		dat = pd.read_hdf( 'Data_Processed/msc/msc_slow_binned.hf' ) 
	...
	if ( scaled ) :
		fname = 'Figures/Slow_Powerlaw_Figs/plot_scaled_' + key + '.pdf'
		#fname = 'eps/plot_scaled_' + key + '.eps'
	else :
		fname = 'Figures/Slow_Powerlaw_Figs/plot_unscaled_' + key + '.pdf'
