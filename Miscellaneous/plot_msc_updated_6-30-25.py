...
def plot_msc( key, scaled=True ) :
	...
	if ( scaled ) :
		dat = pd.read_hdf( 'Data_Processed/msc/all_spacecraft_binned_scaled.hf' )
	else :
		dat = pd.read_hdf( p + 'all_spacecraft_data_85_binned_v2025.03.hf', 'r' )
	...
	if ( scaled ) :
		fname = 'Figures/Power Law Figures 6-30-25/plot_scaled_' + key + '.pdf'
		#fname = 'eps/plot_scaled_' + key + '.eps'
	else :
		fname = 'New_Fits/Power Law Figures 3-26-25/plot_unscaled_' + key + '.pdf'
